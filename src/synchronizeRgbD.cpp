                      ...
                      const sensor_msgs::ImageConstPtr &img_dpt  )
{
    ...
    cv_bridge::CvImagePtr cv_img_rgb;
    cv_bridge::CvImagePtr cv_img_d;
    try
    {
      //std::cout<<"rgb encoding:\t"<<img_rgb->encoding<<std::endl;
      //std::cout<<"  d encoding:\t"<<img_dpt->encoding<<std::endl;
      cv_img_rgb = cv_bridge::toCvCopy(img_rgb, sensor_msgs::image_encodings::BGR8);
      cv_img_d   = cv_bridge::toCvCopy(img_dpt, sensor_msgs::image_encodings::TYPE_32FC1);
    }
